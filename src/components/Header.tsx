...
const Header = () => {
    ...
    return (
        <div className="z-10 max-w-screen w-full items-center justify-between font-mono text-xs lg:flex ">
            ...
            {/*<div className="fixed lg:left-4 left-0 text-lg lg:top-4 top-0 text-gray-700 flex w-full justify-center py-4 backdrop-blur-sm lg:w-auto lg:rounded-xl lg:p-4 bg-[#CCA1A0]/20 md:m-0 lg:m-2">
                <Link href={'/'}>
                    <Image
                        src="/img/LOGO.png"
                        alt="LCRT Logo"
            ...
            <div className="fixed right-2 top-2">
                <div className="flex flex-row w-fit mx-4 place-items-center pt-4 gap-4">
                    <button className="btn btn-md btn-ghost bg-transparent btn-circle">
                        <a href='https://www.instagram.com/noxvisionstudio/' target="_blank">
                            <svg
                                fill='#00000'
                                width="36" height="36"
                                version="1.1"
                    ...
                    <button className="btn btn-md btn-ghost bg-transparent btn-circle">
                        <a href='https://www.facebook.com/people/Noxvisionstudio/61574868299355/' target="_blank">
                            <svg
                                fill="#000000"
                                viewBox="0 0 24 24"
                                width="36" height="36"
                    ...
                    <button className="btn btn-md btn-ghost bg-transparent btn-circle">
                        <a href='https://www.linkedin.com/company/noxvisionstudio' target="_blank">
                            <svg
                                fill="#000000"
                    ...
                    <button className="btn btn-md btn-ghost bg-transparent btn-circle">
                        <a href='mailto:noxvisionstudio@gmail.com'>
                            <svg viewBox="0 0 32 32" fill="00000" width="30" height="30">
